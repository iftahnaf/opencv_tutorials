...
class BalloonKiller(threading.Thread):
    ...
    def scanning(self):
        ...
        while True:
            ...
            if self.center is not None and self.center[0] > self.width/4 and self.center[1] > self.height/4:
    ...
    def positioning(self):
        ...
        if self.center is not None and self.center[1] > self.height / 2.0:
            des_vel.twist.linear.z = -0.1
        elif self.center is not None and self.center[1] < self.height / 2.0:
            des_vel.twist.linear.z = 0.1
        ...
        if self.center is not None and self.center[0] < self.width/2.0:
            des_vel.twist.angular.z = 0.1
        elif self.center is not None and self.center[0] > self.width/2.0:
            des_vel.twist.angular.z = -0.1
